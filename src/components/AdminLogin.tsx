...
const AdminLogin: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg border border-gray-200">
      ...
      {error && (
        <div className="bg-red-50 text-red-800 border border-red-200 p-3 rounded mb-4 text-sm whitespace-pre-line">
          {error}
        </div>
      )}
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          className="w-full mb-4 px-3 py-2 bg-white border border-gray-300 rounded text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500"
        ...
        <input
          ...
          className="w-full mb-6 px-3 py-2 bg-white border border-gray-300 rounded text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500"
          placeholder="••••••••"
        />
